...
#  Streamup
#
#  Created by ted zhang on 2018/7/10.
...
cat "$AUX_PATH/template.applescript" | sed -e "s/WINX/$WINX/g" -e "s/WINY/$WINY/g" -e "s/WINW/$WINW/g" -e "s/WINH/$WINH/g" -e "s/BACKGROUND_CLAUSE/$BACKGROUND_CLAUSE/g" -e "s/REPOSITION_HIDDEN_FILES_CLAUSE/$REPOSITION_HIDDEN_FILES_CLAUSE/g" -e "s/ICON_SIZE/$ICON_SIZE/g" -e "s/TEXT_SIZE/$TEXT_SIZE/g" | perl -p -e  "s%POSITION_CLAUSE%$POSITION_CLAUSE%g" | perl -p -e "s%APPLICATION_CLAUSE%$APPLICATION_CLAUSE%g" | perl -p -e "s%HIDING_CLAUSE%$HIDING_CLAUSE%g" >"$APPLESCRIPT"
